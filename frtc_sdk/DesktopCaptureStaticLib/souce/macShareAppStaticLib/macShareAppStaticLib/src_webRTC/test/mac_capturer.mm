...
@property(nonatomic) webrtc_mac_capturer::test::MacCapturer *capturer;
@end
...
- (void)capturer:(RTC_OBJC_TYPE(RTCVideoCapturer) *)capturer
  ...
  rtc::scoped_refptr<webrtc_mac_capturer::VideoFrameBuffer> buffer =
      new rtc::RefCountedObject<webrtc_mac_capturer::ObjCFrameBuffer>(frame.buffer);
  _capturer->OnFrame(webrtc_mac_capturer::VideoFrame::Builder()
