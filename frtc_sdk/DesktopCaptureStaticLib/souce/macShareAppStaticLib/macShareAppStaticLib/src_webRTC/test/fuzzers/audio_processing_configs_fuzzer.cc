...
std::unique_ptr<AudioProcessing> CreateApm(test::FuzzDataHelper* fuzz_data,
  ...
  // Components can be enabled through webrtc_mac_capturer::Config and
  // webrtc_mac_capturer::AudioProcessingConfig.
  Config config;
  ...
  webrtc_mac_capturer::AudioProcessing::Config apm_config;
  ...
  apm_config.gain_controller2.adaptive_digital.level_estimator =
      use_agc2_adaptive_digital_rms_estimator
          ? webrtc_mac_capturer::AudioProcessing::Config::GainController2::LevelEstimator::
                kRms
          : webrtc_mac_capturer::AudioProcessing::Config::GainController2::LevelEstimator::
                kPeak;
