...
class MockAudioDecoderFactory : public AudioDecoderFactory {
 public:
  ...
  // example.
  static rtc::scoped_refptr<webrtc_mac_capturer::MockAudioDecoderFactory>
  CreateUnusedFactory() {
    using ::testing::_;
    using ::testing::AnyNumber;
    using ::testing::Return;

    rtc::scoped_refptr<webrtc_mac_capturer::MockAudioDecoderFactory> factory =
        rtc::make_ref_counted<webrtc_mac_capturer::MockAudioDecoderFactory>();
