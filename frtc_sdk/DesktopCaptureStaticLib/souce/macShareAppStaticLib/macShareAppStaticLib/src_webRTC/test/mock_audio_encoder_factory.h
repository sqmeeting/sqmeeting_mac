...
class MockAudioEncoderFactory
 ...
 public:
  ...
  // example.
  static rtc::scoped_refptr<webrtc_mac_capturer::MockAudioEncoderFactory>
  CreateUnusedFactory() {
    using ::testing::_;
    using ::testing::AnyNumber;
    using ::testing::Return;

    rtc::scoped_refptr<webrtc_mac_capturer::MockAudioEncoderFactory> factory =
        new rtc::RefCountedObject<webrtc_mac_capturer::MockAudioEncoderFactory>;
    ON_CALL(*factory.get(), GetSupportedEncoders())
        .WillByDefault(Return(std::vector<webrtc_mac_capturer::AudioCodecSpec>()));
