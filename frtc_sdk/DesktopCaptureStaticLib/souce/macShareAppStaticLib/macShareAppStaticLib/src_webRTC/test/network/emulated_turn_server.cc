...
class AsyncPacketSocketWrapper : public rtc::AsyncPacketSocket {
 public:
  AsyncPacketSocketWrapper(webrtc_mac_capturer::test::EmulatedTURNServer* turn_server,
                           webrtc_mac_capturer::EmulatedEndpoint* endpoint,
                           uint16_t port)
 ...
 private:
  webrtc_mac_capturer::test::EmulatedTURNServer* const turn_server_;
  webrtc_mac_capturer::EmulatedEndpoint* const endpoint_;
...
class PacketSocketFactoryWrapper : public rtc::PacketSocketFactory {
 public:
  explicit PacketSocketFactoryWrapper(
      webrtc_mac_capturer::test::EmulatedTURNServer* turn_server)
      : turn_server_(turn_server) {}
 ...
 private:
  webrtc_mac_capturer::test::EmulatedTURNServer* turn_server_;
};
...
void EmulatedTURNServer::OnPacketReceived(webrtc_mac_capturer::EmulatedIpPacket packet) {
