...
bool FramesEqual(const webrtc_mac_capturer::VideoFrame& f1, const webrtc_mac_capturer::VideoFrame& f2) {
...
bool FrameBufsEqual(const rtc::scoped_refptr<webrtc_mac_capturer::VideoFrameBuffer>& f1,
                    const rtc::scoped_refptr<webrtc_mac_capturer::VideoFrameBuffer>& f2) {
  if (f1 == f2) {
    return true;
  }
  ...
  rtc::scoped_refptr<webrtc_mac_capturer::I420BufferInterface> f1_i420 = f1->ToI420();
  rtc::scoped_refptr<webrtc_mac_capturer::I420BufferInterface> f2_i420 = f2->ToI420();
