...
class IvfVideoFrameGeneratorTest : public ::testing::Test {
 protected:
  void SetUp() override {
    file_name_ =
        webrtc_mac_capturer::test::TempFilename(webrtc_mac_capturer::test::OutputPath(), "test_file.ivf");
  }
  void TearDown() override { webrtc_mac_capturer::test::RemoveFile(file_name_); }
  ...
  void CreateTestVideoFile(VideoCodecType video_codec_type,
    ...
    webrtc_mac_capturer::test::CodecSettings(video_codec_type, &codec_settings);
