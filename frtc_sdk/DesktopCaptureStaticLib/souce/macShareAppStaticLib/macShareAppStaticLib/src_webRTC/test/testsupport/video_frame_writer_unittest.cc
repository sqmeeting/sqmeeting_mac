...
void AssertI420BuffersEq(
    rtc::scoped_refptr<webrtc_mac_capturer::I420BufferInterface> actual,
    rtc::scoped_refptr<webrtc_mac_capturer::I420BufferInterface> expected) {
  ASSERT_TRUE(actual);
...
class VideoFrameWriterTest : public ::testing::Test {
 protected:
  ...
  void SetUp() override {
    temp_filename_ = webrtc_mac_capturer::test::TempFilename(webrtc_mac_capturer::test::OutputPath(),
