...
std::string OutputPath() {
  return webrtc_mac_capturer::test::internal::OutputPath();
}

std::string WorkingDir() {
  return webrtc_mac_capturer::test::internal::WorkingDir();
}
...
std::string ResourcePath(const std::string& name,
  ...
  return webrtc_mac_capturer::test::internal::ResourcePath(name, extension);
}
