...
std::string UnitWithDirection(
  ...
  switch (improve_direction) {
    case webrtc_mac_capturer::test::ImproveDirection::kNone:
      return std::string(units);
    case webrtc_mac_capturer::test::ImproveDirection::kSmallerIsBetter:
      return std::string(units) + "_smallerIsBetter";
    case webrtc_mac_capturer::test::ImproveDirection::kBiggerIsBetter:
...
struct PlottableCounter {
  ...
  webrtc_mac_capturer::SamplesStatsCounter counter;
  std::string units;
};
...
class PlottableCounterPrinter {
 public:
  ...
  void AddCounter(absl::string_view graph_name,
                  ...
                  const webrtc_mac_capturer::SamplesStatsCounter& counter,
                  absl::string_view units) {
    MutexLock lock(&mutex_);
