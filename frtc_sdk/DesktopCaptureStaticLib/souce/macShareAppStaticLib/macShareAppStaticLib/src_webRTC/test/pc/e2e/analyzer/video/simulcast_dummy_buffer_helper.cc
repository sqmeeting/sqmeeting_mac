...
rtc::scoped_refptr<webrtc_mac_capturer::VideoFrameBuffer> CreateDummyFrameBuffer() {
  ...
  rtc::scoped_refptr<webrtc_mac_capturer::I420Buffer> buffer =
      webrtc_mac_capturer::I420Buffer::Create(2, 2);
...
bool IsDummyFrameBuffer(
  ...
  rtc::scoped_refptr<webrtc_mac_capturer::I420BufferInterface> buffer =
