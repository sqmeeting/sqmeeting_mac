...
// Helper class that will notify all the webrtc_mac_capturer::test::StatsObserverInterface
// objects subscribed.
...
// webrtc_mac_capturer::StatsObserver that will notify all the
// webrtc_mac_capturer::test::StatsObserverInterface subscribed.
class StatsPoller {
 public:
