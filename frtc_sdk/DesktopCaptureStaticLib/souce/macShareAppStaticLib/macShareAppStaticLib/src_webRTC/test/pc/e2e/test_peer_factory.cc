...
using AudioConfig =
    ::webrtc_mac_capturer::webrtc_pc_e2e::PeerConnectionE2EQualityTestFixture::AudioConfig;
using VideoConfig =
    ::webrtc_mac_capturer::webrtc_pc_e2e::PeerConnectionE2EQualityTestFixture::VideoConfig;
using EchoEmulationConfig = ::webrtc_mac_capturer::webrtc_pc_e2e::
...
std::unique_ptr<cricket::MediaEngineInterface> CreateMediaEngine(
  ...
  webrtc_mac_capturer::SetMediaEngineDefaults(&media_deps);
...
std::unique_ptr<TestPeer> TestPeerFactory::CreateTestPeer(
  ...
  rtc::scoped_refptr<AudioProcessing> audio_processing =
      webrtc_mac_capturer::AudioProcessingBuilder().Create();
