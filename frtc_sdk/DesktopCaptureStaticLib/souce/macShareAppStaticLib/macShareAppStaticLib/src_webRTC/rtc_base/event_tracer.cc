...
class EventLogger final {
 ...
 private:
  ...
  webrtc_mac_capturer::SequenceChecker thread_checker_;
...
void SetupInternalTracer() {
  ...
  webrtc_mac_capturer::SetupEventTracer(InternalGetCategoryEnabled, InternalAddTraceEvent);
}
...
void ShutdownInternalTracer() {
  ...
  delete old_logger;
  webrtc_mac_capturer::SetupEventTracer(nullptr, nullptr);
}
