...
webrtc_mac_capturer::MdnsResponderInterface* NetworkManager::GetMdnsResponder() const {
  return nullptr;
}

NetworkManagerBase::NetworkManagerBase()
    : enumeration_permission_(NetworkManager::ENUMERATION_ALLOWED),
      signal_network_preference_change_(webrtc_mac_capturer::field_trial::IsEnabled(
...
BasicNetworkManager::BasicNetworkManager(
    ...
    : network_monitor_factory_(network_monitor_factory),
      allow_mac_based_ipv6_(
          webrtc_mac_capturer::field_trial::IsEnabled("WebRTC-AllowMACBasedIPv6")),
      bind_using_ifname_(
          !webrtc_mac_capturer::field_trial::IsDisabled("WebRTC-BindUsingInterfaceName")) {}
...
Network::Network(const std::string& name,
    ...
    : name_(name),
      ...
      preference_(0),
      use_differentiated_cellular_costs_(webrtc_mac_capturer::field_trial::IsEnabled(
...
webrtc_mac_capturer::MdnsResponderInterface* Network::GetMdnsResponder() const {
