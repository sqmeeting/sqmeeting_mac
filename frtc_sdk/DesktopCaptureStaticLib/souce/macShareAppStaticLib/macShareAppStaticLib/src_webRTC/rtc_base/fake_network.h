...
class FakeNetworkManager : public NetworkManagerBase,
 ...
 public:
  ...
  webrtc_mac_capturer::MdnsResponderInterface* GetMdnsResponder() const override {
    return mdns_responder_.get();
  }

  void set_mdns_responder(
      std::unique_ptr<webrtc_mac_capturer::MdnsResponderInterface> mdns_responder) {
 ...
 private:
  ...
  std::unique_ptr<webrtc_mac_capturer::MdnsResponderInterface> mdns_responder_;
};
