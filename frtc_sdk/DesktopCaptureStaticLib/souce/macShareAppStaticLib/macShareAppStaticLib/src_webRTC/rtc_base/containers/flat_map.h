...
class flat_map : public ::webrtc_mac_capturer::flat_containers_internal::flat_tree<
                     Key,
                     flat_containers_internal::GetFirst,
                     Compare,
                     Container> {
 private:
  using tree = typename ::webrtc_mac_capturer::flat_containers_internal::
...
using ::webrtc_mac_capturer::flat_containers_internal::EraseIf;
