...
// Starts at time 0.
//
// TODO(deadbeef): Unify with webrtc_mac_capturer::SimulatedClock.
class FakeClock : public ClockInterface {
 public:
  ...
  void SetTime(webrtc_mac_capturer::Timestamp new_time);

  void AdvanceTime(webrtc_mac_capturer::TimeDelta delta);

 private:
  mutable webrtc_mac_capturer::Mutex lock_;
...
class ThreadProcessingFakeClock : public ClockInterface {
 public:
  ...
  void SetTime(webrtc_mac_capturer::Timestamp time);
  void AdvanceTime(webrtc_mac_capturer::TimeDelta delta);
