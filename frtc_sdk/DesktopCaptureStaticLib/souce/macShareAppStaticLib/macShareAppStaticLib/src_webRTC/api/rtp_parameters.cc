...
bool RtpExtension::IsSupportedForAudio(absl::string_view uri) {
  return uri == webrtc_mac_capturer::RtpExtension::kAudioLevelUri ||
         uri == webrtc_mac_capturer::RtpExtension::kAbsSendTimeUri ||
         uri == webrtc_mac_capturer::RtpExtension::kAbsoluteCaptureTimeUri ||
         uri == webrtc_mac_capturer::RtpExtension::kTransportSequenceNumberUri ||
         uri == webrtc_mac_capturer::RtpExtension::kTransportSequenceNumberV2Uri ||
         uri == webrtc_mac_capturer::RtpExtension::kMidUri ||
         uri == webrtc_mac_capturer::RtpExtension::kRidUri ||
         uri == webrtc_mac_capturer::RtpExtension::kRepairedRidUri;
}

bool RtpExtension::IsSupportedForVideo(absl::string_view uri) {
  return uri == webrtc_mac_capturer::RtpExtension::kTimestampOffsetUri ||
         uri == webrtc_mac_capturer::RtpExtension::kAbsSendTimeUri ||
         uri == webrtc_mac_capturer::RtpExtension::kAbsoluteCaptureTimeUri ||
         uri == webrtc_mac_capturer::RtpExtension::kVideoRotationUri ||
         uri == webrtc_mac_capturer::RtpExtension::kTransportSequenceNumberUri ||
         uri == webrtc_mac_capturer::RtpExtension::kTransportSequenceNumberV2Uri ||
         uri == webrtc_mac_capturer::RtpExtension::kPlayoutDelayUri ||
         uri == webrtc_mac_capturer::RtpExtension::kVideoContentTypeUri ||
         uri == webrtc_mac_capturer::RtpExtension::kVideoTimingUri ||
         uri == webrtc_mac_capturer::RtpExtension::kMidUri ||
         uri == webrtc_mac_capturer::RtpExtension::kGenericFrameDescriptorUri00 ||
         uri == webrtc_mac_capturer::RtpExtension::kDependencyDescriptorUri ||
         uri == webrtc_mac_capturer::RtpExtension::kColorSpaceUri ||
         uri == webrtc_mac_capturer::RtpExtension::kRidUri ||
         uri == webrtc_mac_capturer::RtpExtension::kRepairedRidUri ||
         uri == webrtc_mac_capturer::RtpExtension::kVideoLayersAllocationUri ||
         uri == webrtc_mac_capturer::RtpExtension::kVideoFrameTrackingIdUri;
}
...
bool RtpExtension::IsEncryptionSupported(absl::string_view uri) {
  return
      ...
      uri != webrtc_mac_capturer::RtpExtension::kAbsSendTimeUri &&
#endif
      uri != webrtc_mac_capturer::RtpExtension::kEncryptHeaderExtensionsUri;
}
...
const RtpExtension* RtpExtension::FindHeaderExtensionByUri(
    ...
    absl::string_view uri,
    Filter filter) {
  const webrtc_mac_capturer::RtpExtension* fallback_extension = nullptr;
  for (const auto& extension : extensions) {
    if (extension.uri != uri) {
      continue;
    }
