...
class RTC_EXPORT PeerConnectionInterface : public rtc::RefCountInterface {
 public:
  ...
  struct RTC_EXPORT RTCConfiguration {
    ...
    // called.
    webrtc_mac_capturer::TurnCustomizer* turn_customizer = nullptr;
...
struct RTC_EXPORT PeerConnectionDependencies final {
  ...
  std::unique_ptr<webrtc_mac_capturer::AsyncDnsResolverFactoryInterface>
      async_dns_resolver_factory;
  // Deprecated - use async_dns_resolver_factory
  std::unique_ptr<webrtc_mac_capturer::AsyncResolverFactory> async_resolver_factory;
  std::unique_ptr<webrtc_mac_capturer::IceTransportFactory> ice_transport_factory;
  std::unique_ptr<rtc::RTCCertificateGeneratorInterface> cert_generator;
  std::unique_ptr<rtc::SSLCertificateVerifier> tls_cert_verifier;
  std::unique_ptr<webrtc_mac_capturer::VideoBitrateAllocatorFactory>
