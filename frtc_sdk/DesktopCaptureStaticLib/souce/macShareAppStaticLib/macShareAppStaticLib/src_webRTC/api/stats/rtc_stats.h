...
#define WEBRTC_RTCSTATS_DECL()                                          \
 protected:                                                             \
  std::vector<const webrtc_mac_capturer::RTCStatsMemberInterface*>                   \
 ...
 public:                                                                \
  static const char kType[];                                            \
                                                                        \
  std::unique_ptr<webrtc_mac_capturer::RTCStats> copy() const override;              \
  const char* type() const override

#define WEBRTC_RTCSTATS_IMPL(this_class, parent_class, type_str, ...)          \
  const char this_class::kType[] = type_str;                                   \
                                                                               \
  std::unique_ptr<webrtc_mac_capturer::RTCStats> this_class::copy() const {                 \
    return std::unique_ptr<webrtc_mac_capturer::RTCStats>(new this_class(*this));           \
  }                                                                            \
                                                                               \
  ...
  this_class::MembersOfThisObjectAndAncestors(                                 \
    ...
    const webrtc_mac_capturer::RTCStatsMemberInterface* local_var_members[] = {             \
        __VA_ARGS__};                                                          \
