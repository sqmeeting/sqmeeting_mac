...
webrtc_mac_capturer::RTCError RtpTransceiverInterface::SetOfferedRtpHeaderExtensions(
    rtc::ArrayView<const RtpHeaderExtensionCapability>
        header_extensions_to_offer) {
  return webrtc_mac_capturer::RTCError(webrtc_mac_capturer::RTCErrorType::UNSUPPORTED_OPERATION);
}
