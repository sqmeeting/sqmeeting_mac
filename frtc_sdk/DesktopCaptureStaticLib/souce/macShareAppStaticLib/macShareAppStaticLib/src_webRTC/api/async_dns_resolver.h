...
class AsyncDnsResolverFactoryInterface {
 public:
  ...
  virtual std::unique_ptr<webrtc_mac_capturer::AsyncDnsResolverInterface> CreateAndResolve(
  ...
  virtual std::unique_ptr<webrtc_mac_capturer::AsyncDnsResolverInterface> Create() = 0;
};
