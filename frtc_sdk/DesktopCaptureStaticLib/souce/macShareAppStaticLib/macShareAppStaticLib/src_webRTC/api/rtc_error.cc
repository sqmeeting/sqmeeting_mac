...
static_assert(
    static_cast<int>(webrtc_mac_capturer::RTCErrorType::OPERATION_ERROR_WITH_DATA) ==
...
static_assert(
    static_cast<int>(webrtc_mac_capturer::RTCErrorDetailType::HARDWARE_ENCODER_ERROR) ==
