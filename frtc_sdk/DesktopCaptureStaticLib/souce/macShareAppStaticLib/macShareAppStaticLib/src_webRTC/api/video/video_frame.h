...
class RTC_EXPORT VideoFrame {
 public:
  ...
  class RTC_EXPORT Builder {
   ...
   private:
    uint16_t id_ = 0;
    rtc::scoped_refptr<webrtc_mac_capturer::VideoFrameBuffer> video_frame_buffer_;
  ...
  VideoFrame(const rtc::scoped_refptr<VideoFrameBuffer>& buffer,
             webrtc_mac_capturer::VideoRotation rotation,
  ...
  // TODO(nisse): After the cricket::VideoFrame and webrtc_mac_capturer::VideoFrame
  ...
  rtc::scoped_refptr<webrtc_mac_capturer::VideoFrameBuffer> video_frame_buffer() const;
