...
- (void)testConversionToNativeConfiguration {
  ...
  EXPECT_EQ(webrtc_mac_capturer::PeerConnectionInterface::kRelay, nativeConfig->type);
  EXPECT_EQ(webrtc_mac_capturer::PeerConnectionInterface::kBundlePolicyMaxBundle,
            nativeConfig->bundle_policy);
  EXPECT_EQ(webrtc_mac_capturer::PeerConnectionInterface::kRtcpMuxPolicyNegotiate,
            nativeConfig->rtcp_mux_policy);
  EXPECT_EQ(webrtc_mac_capturer::PeerConnectionInterface::kTcpCandidatePolicyDisabled,
            nativeConfig->tcp_candidate_policy);
  EXPECT_EQ(webrtc_mac_capturer::PeerConnectionInterface::kCandidateNetworkPolicyLowCost,
  ...
  EXPECT_EQ(webrtc_mac_capturer::PeerConnectionInterface::GATHER_CONTINUALLY,
...
- (void)testNativeConversionToConfiguration {
  ...
  webrtc_mac_capturer::PeerConnectionInterface::RTCConfiguration *nativeConfig =
