...
- (void)testInitializedWithNativeEncodedImage {
  const auto encoded_data = webrtc_mac_capturer::EncodedImageBuffer::Create();
...
- (void)testInitWithNSData {
  ...
  webrtc_mac_capturer::EncodedImage result_encoded_image = [encodedImage nativeEncodedImage];
