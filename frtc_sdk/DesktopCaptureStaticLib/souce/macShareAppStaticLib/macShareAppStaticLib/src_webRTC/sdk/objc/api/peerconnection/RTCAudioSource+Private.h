...
()
     ...
     */
    @property(nonatomic,
              readonly) rtc::scoped_refptr<webrtc_mac_capturer::AudioSourceInterface> nativeAudioSource;

/** Initialize an RTCAudioSource from a native AudioSourceInterface. */
- (instancetype)initWithFactory:(RTC_OBJC_TYPE(RTCPeerConnectionFactory) *)factory
              nativeAudioSource:(rtc::scoped_refptr<webrtc_mac_capturer::AudioSourceInterface>)nativeAudioSource
