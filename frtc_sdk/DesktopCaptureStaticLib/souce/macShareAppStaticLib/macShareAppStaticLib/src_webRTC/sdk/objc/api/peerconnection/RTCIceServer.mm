...
- (webrtc_mac_capturer::PeerConnectionInterface::IceServer)nativeServer {
  __block webrtc_mac_capturer::PeerConnectionInterface::IceServer iceServer;
  ...
  switch (_tlsCertPolicy) {
    case RTCTlsCertPolicySecure:
      iceServer.tls_cert_policy =
          webrtc_mac_capturer::PeerConnectionInterface::kTlsCertPolicySecure;
      break;
    case RTCTlsCertPolicyInsecureNoCheck:
      iceServer.tls_cert_policy =
          webrtc_mac_capturer::PeerConnectionInterface::kTlsCertPolicyInsecureNoCheck;
      break;
  }
  return iceServer;
}
...
- (instancetype)initWithNativeServer:
  ...
  switch (nativeServer.tls_cert_policy) {
    case webrtc_mac_capturer::PeerConnectionInterface::kTlsCertPolicySecure:
      tlsCertPolicy = RTCTlsCertPolicySecure;
      break;
    case webrtc_mac_capturer::PeerConnectionInterface::kTlsCertPolicyInsecureNoCheck:
