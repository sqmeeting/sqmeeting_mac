...
// Extract VideoToolbox profile out of the webrtc_mac_capturer::SdpVideoFormat. If there is
// no specific VideoToolbox profile for the specified level, AutoLevel will be
// returned. The user must initialize the encoder with a resolution and
// framerate conforming to the selected H264 level regardless.
CFStringRef ExtractProfile(const webrtc_mac_capturer::H264ProfileLevelId &profile_level_id) {
  switch (profile_level_id.profile) {
    case webrtc_mac_capturer::H264Profile::kProfileConstrainedBaseline:
    case webrtc_mac_capturer::H264Profile::kProfileBaseline:
      switch (profile_level_id.level) {
        case webrtc_mac_capturer::H264Level::kLevel3:
          return kVTProfileLevel_H264_Baseline_3_0;
        case webrtc_mac_capturer::H264Level::kLevel3_1:
          return kVTProfileLevel_H264_Baseline_3_1;
        case webrtc_mac_capturer::H264Level::kLevel3_2:
          return kVTProfileLevel_H264_Baseline_3_2;
        case webrtc_mac_capturer::H264Level::kLevel4:
          return kVTProfileLevel_H264_Baseline_4_0;
        case webrtc_mac_capturer::H264Level::kLevel4_1:
          return kVTProfileLevel_H264_Baseline_4_1;
        case webrtc_mac_capturer::H264Level::kLevel4_2:
          return kVTProfileLevel_H264_Baseline_4_2;
        case webrtc_mac_capturer::H264Level::kLevel5:
          return kVTProfileLevel_H264_Baseline_5_0;
        case webrtc_mac_capturer::H264Level::kLevel5_1:
          return kVTProfileLevel_H264_Baseline_5_1;
        case webrtc_mac_capturer::H264Level::kLevel5_2:
          return kVTProfileLevel_H264_Baseline_5_2;
        case webrtc_mac_capturer::H264Level::kLevel1:
        case webrtc_mac_capturer::H264Level::kLevel1_b:
        case webrtc_mac_capturer::H264Level::kLevel1_1:
        case webrtc_mac_capturer::H264Level::kLevel1_2:
        case webrtc_mac_capturer::H264Level::kLevel1_3:
        case webrtc_mac_capturer::H264Level::kLevel2:
        case webrtc_mac_capturer::H264Level::kLevel2_1:
        case webrtc_mac_capturer::H264Level::kLevel2_2:
          return kVTProfileLevel_H264_Baseline_AutoLevel;
      }

    case webrtc_mac_capturer::H264Profile::kProfileMain:
      switch (profile_level_id.level) {
        case webrtc_mac_capturer::H264Level::kLevel3:
    ...
    case webrtc_mac_capturer::H264Profile::kProfileConstrainedHigh:
    case webrtc_mac_capturer::H264Profile::kProfileHigh:
      switch (profile_level_id.level) {
        case webrtc_mac_capturer::H264Level::kLevel3:
...
// for details.
NSUInteger GetMaxSampleRate(const webrtc_mac_capturer::H264ProfileLevelId &profile_level_id) {
  switch (profile_level_id.level) {
    case webrtc_mac_capturer::H264Level::kLevel3:
      return 10368000;
    case webrtc_mac_capturer::H264Level::kLevel3_1:
...
@implementation RTC_OBJC_TYPE (RTCVideoEncoderH264) {
  ...
  std::unique_ptr<webrtc_mac_capturer::BitrateAdjuster> _bitrateAdjuster;
  uint32_t _targetBitrateBps;
  uint32_t _encoderBitrateBps;
  uint32_t _encoderFrameRate;
  uint32_t _maxAllowedFrameRate;
  RTCH264PacketizationMode _packetizationMode;
  absl::optional<webrtc_mac_capturer::H264ProfileLevelId> _profile_level_id;
  ...
  webrtc_mac_capturer::H264BitstreamParser _h264BitstreamParser;
...
- (instancetype)initWithCodecInfo:(RTC_OBJC_TYPE(RTCVideoCodecInfo) *)codecInfo {
  if (self = [super init]) {
    ...
    _bitrateAdjuster.reset(new webrtc_mac_capturer::BitrateAdjuster(.5, .95));
    _packetizationMode = RTCH264PacketizationModeNonInterleaved;
    _profile_level_id =
        webrtc_mac_capturer::ParseSdpForH264ProfileLevelId([codecInfo nativeSdpVideoFormat].parameters);
...
- (void)frameWasEncoded:(OSStatus)status
  ...
  if (!webrtc_mac_capturer::H264CMSampleBufferToAnnexBBuffer(sampleBuffer, isKeyframe, buffer.get())) {
    return;
  }
  ...
  frame.flags = webrtc_mac_capturer::VideoSendTiming::kInvalid;
