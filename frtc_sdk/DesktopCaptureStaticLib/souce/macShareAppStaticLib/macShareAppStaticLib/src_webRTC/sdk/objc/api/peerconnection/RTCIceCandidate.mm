...
- (instancetype)initWithNativeCandidate:
    (const webrtc_mac_capturer::IceCandidateInterface *)candidate {
...
- (std::unique_ptr<webrtc_mac_capturer::IceCandidateInterface>)nativeCandidate {
  webrtc_mac_capturer::SdpParseError error;

  webrtc_mac_capturer::IceCandidateInterface *candidate = webrtc_mac_capturer::CreateIceCandidate(
  ...
  return std::unique_ptr<webrtc_mac_capturer::IceCandidateInterface>(candidate);
}
