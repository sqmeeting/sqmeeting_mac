...
void setNetworkBit(webrtc_mac_capturer::PeerConnectionFactoryInterface::Options* options,
...
- (webrtc_mac_capturer::PeerConnectionFactoryInterface::Options)nativeOptions {
  webrtc_mac_capturer::PeerConnectionFactoryInterface::Options options;
