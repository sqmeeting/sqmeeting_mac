...
()
    ...
    @property(nonatomic, readonly) webrtc_mac_capturer::RtpParameters nativeParameters;

/** Initialize the object with a native RtpParameters structure. */
- (instancetype)initWithNativeParameters:(const webrtc_mac_capturer::RtpParameters &)nativeParameters
