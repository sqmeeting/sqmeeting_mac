...
- (instancetype)initWithStatistics:(const webrtc_mac_capturer::RTCStats &)statistics {
  if (self = [super init]) {
    ...
    for (const webrtc_mac_capturer::RTCStatsMemberInterface *member : statistics.Members()) {
...
- (instancetype)initWithReport : (const webrtc_mac_capturer::RTCStatsReport &)report {
  if (self = [super init]) {
