                    ...
                    (rtc::scoped_refptr<webrtc_mac_capturer::AudioEncoderFactory>)audioEncoderFactory
                        ...
                        nativeVideoDecoderFactory:
                            (std::unique_ptr<webrtc_mac_capturer::VideoDecoderFactory>)videoDecoderFactory
                                audioDeviceModule:
                                    (nullable webrtc_mac_capturer::AudioDeviceModule *)audioDeviceModule
...
- (instancetype)
    initWithNativeAudioEncoderFactory:
        (rtc::scoped_refptr<webrtc_mac_capturer::AudioEncoderFactory>)audioEncoderFactory
            ...
            nativeVideoDecoderFactory:
                (std::unique_ptr<webrtc_mac_capturer::VideoDecoderFactory>)videoDecoderFactory
                    audioDeviceModule:(nullable webrtc_mac_capturer::AudioDeviceModule *)audioDeviceModule
                audioProcessingModule:
                    (rtc::scoped_refptr<webrtc_mac_capturer::AudioProcessing>)audioProcessingModule
             networkControllerFactory:(std::unique_ptr<webrtc_mac_capturer::NetworkControllerFactoryInterface>)
