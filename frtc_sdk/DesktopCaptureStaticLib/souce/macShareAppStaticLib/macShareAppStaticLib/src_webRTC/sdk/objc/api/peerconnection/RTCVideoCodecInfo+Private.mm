...
(Private)
    ...
    - (instancetype)initWithNativeSdpVideoFormat : (webrtc_mac_capturer::SdpVideoFormat)format {
...
- (webrtc_mac_capturer::SdpVideoFormat)nativeSdpVideoFormat {
  ...
  return webrtc_mac_capturer::SdpVideoFormat([NSString stdStringForString:self.name], parameters);
}
