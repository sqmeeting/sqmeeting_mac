...
TEST(AVFormatMapperTest, SuportedCricketFormatsWithInvalidFramerateFormats) {
  ...
  std::set<cricket::VideoFormat> result =
      webrtc_mac_capturer::GetSupportedVideoFormatsForDevice(mockDevice);
...
TEST(AVFormatMapperTest, MediaSubtypePreference) {
  ...
  // when
  bool resultFormat =
      webrtc_mac_capturer::SetFormatForCaptureDevice(mockDevice, nil, expectedFormat);
...
TEST(AVFormatMapperTest, SetFormatWhenDeviceCannotLock) {
  ...
  // when
  bool resultFormat = webrtc_mac_capturer::SetFormatForCaptureDevice(mockDevice, nil,
                                                        cricket::VideoFormat());
