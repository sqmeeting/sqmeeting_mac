...
- (instancetype)initWithFactory:(RTC_OBJC_TYPE(RTCPeerConnectionFactory) *)factory
  ...
  rtc::scoped_refptr<webrtc_mac_capturer::AudioTrackInterface> track =
...
- (rtc::scoped_refptr<webrtc_mac_capturer::AudioTrackInterface>)nativeAudioTrack {
  return static_cast<webrtc_mac_capturer::AudioTrackInterface *>(self.nativeTrack.get());
}
