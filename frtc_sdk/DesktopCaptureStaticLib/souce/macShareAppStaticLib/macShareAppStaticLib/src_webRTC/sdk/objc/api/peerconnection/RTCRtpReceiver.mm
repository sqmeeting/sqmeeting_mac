...
@implementation RTC_OBJC_TYPE (RTCRtpReceiver) {
  ...
  rtc::scoped_refptr<webrtc_mac_capturer::RtpReceiverInterface> _nativeRtpReceiver;
  std::unique_ptr<webrtc_mac_capturer::RtpReceiverDelegateAdapter> _observer;
}
...
- (void)setFrameDecryptor:(rtc::scoped_refptr<webrtc_mac_capturer::FrameDecryptorInterface>)frameDecryptor {
  _nativeRtpReceiver->SetFrameDecryptor(frameDecryptor);
}

#pragma mark - Private

- (rtc::scoped_refptr<webrtc_mac_capturer::RtpReceiverInterface>)nativeRtpReceiver {
...
- (instancetype)initWithFactory:(RTC_OBJC_TYPE(RTCPeerConnectionFactory) *)factory
  ...
  if (self = [super init]) {
    ...
    _observer.reset(new webrtc_mac_capturer::RtpReceiverDelegateAdapter(self));
