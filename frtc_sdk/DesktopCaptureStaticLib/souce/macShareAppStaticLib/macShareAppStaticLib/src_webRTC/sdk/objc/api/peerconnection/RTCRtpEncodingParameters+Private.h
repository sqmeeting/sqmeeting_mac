...
()
    ...
    @property(nonatomic, readonly) webrtc_mac_capturer::RtpEncodingParameters nativeParameters;

/** Initialize the object with a native RtpEncodingParameters structure. */
- (instancetype)initWithNativeParameters:(const webrtc_mac_capturer::RtpEncodingParameters &)nativeParameters
