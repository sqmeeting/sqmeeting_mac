...
- (instancetype)initWithWidth:(int)width height:(int)height {
  if (self = [super init]) {
    _i420Buffer = webrtc_mac_capturer::I420Buffer::Create(width, height);
  }
...
- (instancetype)initWithWidth:(int)width
  ...
  if (self = [super init]) {
    _i420Buffer = webrtc_mac_capturer::I420Buffer::Copy(
...
- (instancetype)initWithWidth:(int)width
                      ...
                      strideV:(int)strideV {
  if (self = [super init]) {
    _i420Buffer = webrtc_mac_capturer::I420Buffer::Create(width, height, strideY, strideU, strideV);
  }

  return self;
}

- (instancetype)initWithFrameBuffer:(rtc::scoped_refptr<webrtc_mac_capturer::I420BufferInterface>)i420Buffer {
  if (self = [super init]) {
...
- (rtc::scoped_refptr<webrtc_mac_capturer::I420BufferInterface>)nativeI420Buffer {
  return _i420Buffer;
}
