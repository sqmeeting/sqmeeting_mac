...
()
    ...
    @property(nonatomic, readonly) webrtc_mac_capturer::RtpCodecParameters nativeParameters;

/** Initialize the object with a native RtpCodecParameters structure. */
- (instancetype)initWithNativeParameters:(const webrtc_mac_capturer::RtpCodecParameters &)nativeParameters
