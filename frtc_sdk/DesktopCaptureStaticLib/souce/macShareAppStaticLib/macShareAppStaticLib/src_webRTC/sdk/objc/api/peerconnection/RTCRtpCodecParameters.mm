...
- (instancetype)init {
  webrtc_mac_capturer::RtpCodecParameters nativeParameters;
  return [self initWithNativeParameters:nativeParameters];
}

- (instancetype)initWithNativeParameters:
    (const webrtc_mac_capturer::RtpCodecParameters &)nativeParameters {
  if (self = [super init]) {
...
- (webrtc_mac_capturer::RtpCodecParameters)nativeParameters {
  webrtc_mac_capturer::RtpCodecParameters parameters;
