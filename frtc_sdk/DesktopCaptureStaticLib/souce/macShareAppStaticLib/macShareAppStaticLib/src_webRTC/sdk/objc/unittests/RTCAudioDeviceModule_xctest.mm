...
class MockAudioTransport : public webrtc_mac_capturer::AudioTransport {
public:
  MockAudioTransport() {}
...
@property(nonatomic, assign) webrtc_mac_capturer::AudioParameters playoutParameters;
@property(nonatomic, assign) webrtc_mac_capturer::AudioParameters recordParameters;
...
- (void)setUp {
  [super setUp];
  audioDeviceModule = webrtc_mac_capturer::CreateAudioDeviceModule();
...
- (void)testStartPlayoutOnTwoInstances {
  ...
  rtc::scoped_refptr<webrtc_mac_capturer::AudioDeviceModule> secondAudioDeviceModule =
      webrtc_mac_capturer::CreateAudioDeviceModule();
