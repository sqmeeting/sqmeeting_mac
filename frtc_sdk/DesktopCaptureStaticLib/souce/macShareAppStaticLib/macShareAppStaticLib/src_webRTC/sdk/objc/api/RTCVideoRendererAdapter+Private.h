 ...
 * Calls made to the webrtc_mac_capturer::VideoRenderInterface will be adapted and passed to
 * this video renderer.
 */
 ...
 */
@property(nonatomic, readonly) rtc::VideoSinkInterface<webrtc_mac_capturer::VideoFrame> *nativeVideoRenderer;
