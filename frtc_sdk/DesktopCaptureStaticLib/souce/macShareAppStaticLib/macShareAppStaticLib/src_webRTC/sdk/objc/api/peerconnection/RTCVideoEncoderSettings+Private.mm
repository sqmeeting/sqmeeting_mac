...
(Private)
    ...
    - (instancetype)initWithNativeVideoCodec : (const webrtc_mac_capturer::VideoCodec *)videoCodec {
  if (self = [super init]) {
    if (videoCodec) {
...
- (webrtc_mac_capturer::VideoCodec)nativeVideoCodec {
  webrtc_mac_capturer::VideoCodec videoCodec;
  ...
  videoCodec.mode = (webrtc_mac_capturer::VideoCodecMode)self.mode;
