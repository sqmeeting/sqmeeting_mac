...
- (webrtc_mac_capturer::RtpTransceiverInit)nativeInit {
  webrtc_mac_capturer::RtpTransceiverInit init;
  init.direction =
...
@implementation RTC_OBJC_TYPE (RTCRtpTransceiver) {
  ...
  rtc::scoped_refptr<webrtc_mac_capturer::RtpTransceiverInterface> _nativeRtpTransceiver;
}
...
- (void)setDirection:(RTCRtpTransceiverDirection)direction error:(NSError **)error {
  webrtc_mac_capturer::RTCError nativeError = _nativeRtpTransceiver->SetDirectionWithError(
...
- (rtc::scoped_refptr<webrtc_mac_capturer::RtpTransceiverInterface>)nativeRtpTransceiver {
...
+ (webrtc_mac_capturer::RtpTransceiverDirection)nativeRtpTransceiverDirectionFromDirection:
        (RTCRtpTransceiverDirection)direction {
  switch (direction) {
    case RTCRtpTransceiverDirectionSendRecv:
      return webrtc_mac_capturer::RtpTransceiverDirection::kSendRecv;
    case RTCRtpTransceiverDirectionSendOnly:
      return webrtc_mac_capturer::RtpTransceiverDirection::kSendOnly;
    case RTCRtpTransceiverDirectionRecvOnly:
      return webrtc_mac_capturer::RtpTransceiverDirection::kRecvOnly;
    case RTCRtpTransceiverDirectionInactive:
      return webrtc_mac_capturer::RtpTransceiverDirection::kInactive;
    case RTCRtpTransceiverDirectionStopped:
      return webrtc_mac_capturer::RtpTransceiverDirection::kStopped;
  }
}

+ (RTCRtpTransceiverDirection)rtpTransceiverDirectionFromNativeDirection:
        (webrtc_mac_capturer::RtpTransceiverDirection)nativeDirection {
  switch (nativeDirection) {
    case webrtc_mac_capturer::RtpTransceiverDirection::kSendRecv:
      return RTCRtpTransceiverDirectionSendRecv;
    case webrtc_mac_capturer::RtpTransceiverDirection::kSendOnly:
      return RTCRtpTransceiverDirectionSendOnly;
    case webrtc_mac_capturer::RtpTransceiverDirection::kRecvOnly:
      return RTCRtpTransceiverDirectionRecvOnly;
    case webrtc_mac_capturer::RtpTransceiverDirection::kInactive:
      return RTCRtpTransceiverDirectionInactive;
    case webrtc_mac_capturer::RtpTransceiverDirection::kStopped:
