...
()
     ...
     */
    @property(nonatomic, readonly) std::unique_ptr<webrtc_mac_capturer::IceCandidateInterface> nativeCandidate;

/**
 * Initialize an RTCIceCandidate from a native IceCandidateInterface. No
 * ownership is taken of the native candidate.
 */
- (instancetype)initWithNativeCandidate:(const webrtc_mac_capturer::IceCandidateInterface *)candidate;
