...
- (instancetype)init {
  webrtc_mac_capturer::RtpEncodingParameters nativeParameters;
  return [self initWithNativeParameters:nativeParameters];
}

- (instancetype)initWithNativeParameters:
    (const webrtc_mac_capturer::RtpEncodingParameters &)nativeParameters {
  if (self = [super init]) {
...
- (webrtc_mac_capturer::RtpEncodingParameters)nativeParameters {
  webrtc_mac_capturer::RtpEncodingParameters parameters;
  if (_rid != nil) {
...
+ (webrtc_mac_capturer::Priority)nativePriorityFromPriority:(RTCPriority)networkPriority {
  switch (networkPriority) {
    case RTCPriorityVeryLow:
      return webrtc_mac_capturer::Priority::kVeryLow;
    case RTCPriorityLow:
      return webrtc_mac_capturer::Priority::kLow;
    case RTCPriorityMedium:
      return webrtc_mac_capturer::Priority::kMedium;
    case RTCPriorityHigh:
      return webrtc_mac_capturer::Priority::kHigh;
  }
}

+ (RTCPriority)priorityFromNativePriority:(webrtc_mac_capturer::Priority)nativePriority {
  switch (nativePriority) {
    case webrtc_mac_capturer::Priority::kVeryLow:
      return RTCPriorityVeryLow;
    case webrtc_mac_capturer::Priority::kLow:
      return RTCPriorityLow;
    case webrtc_mac_capturer::Priority::kMedium:
      return RTCPriorityMedium;
    case webrtc_mac_capturer::Priority::kHigh:
