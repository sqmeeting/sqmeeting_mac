...
(Stats)
  ...
  rtc::scoped_refptr<webrtc_mac_capturer::StatsCollectorCallbackAdapter> collector(
      new rtc::RefCountedObject<webrtc_mac_capturer::StatsCollectorCallbackAdapter>(completionHandler));
...
- (void)statsForTrack:(RTC_OBJC_TYPE(RTCMediaStreamTrack) *)mediaStreamTrack
  ...
  rtc::scoped_refptr<webrtc_mac_capturer::StatsObserverAdapter> observer(
      new rtc::RefCountedObject<webrtc_mac_capturer::StatsObserverAdapter>
          (completionHandler));
  webrtc_mac_capturer::PeerConnectionInterface::StatsOutputLevel nativeOutputLevel =
