...
- (instancetype)initWithFactory:(RTC_OBJC_TYPE(RTCPeerConnectionFactory) *)factory
  ...
  rtc::scoped_refptr<webrtc_mac_capturer::VideoTrackInterface> track =
...
- (instancetype)initWithFactory:(RTC_OBJC_TYPE(RTCPeerConnectionFactory) *)factory
                    nativeTrack:
                        (rtc::scoped_refptr<webrtc_mac_capturer::MediaStreamTrackInterface>)nativeMediaTrack
...
- (RTC_OBJC_TYPE(RTCVideoSource) *)source {
  if (!_source) {
    rtc::scoped_refptr<webrtc_mac_capturer::VideoTrackSourceInterface> source =
...
- (rtc::scoped_refptr<webrtc_mac_capturer::VideoTrackInterface>)nativeVideoTrack {
  return static_cast<webrtc_mac_capturer::VideoTrackInterface *>(self.nativeTrack.get());
}
