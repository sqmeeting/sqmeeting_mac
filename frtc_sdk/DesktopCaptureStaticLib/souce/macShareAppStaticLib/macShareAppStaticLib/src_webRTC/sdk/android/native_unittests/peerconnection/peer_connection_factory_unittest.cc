...
rtc::scoped_refptr<webrtc_mac_capturer::PeerConnectionFactoryInterface> CreateTestPCF(
    JNIEnv* jni,
  ...
  media_deps.video_encoder_factory =
      std::make_unique<webrtc_mac_capturer::InternalEncoderFactory>();
  media_deps.video_decoder_factory =
      std::make_unique<webrtc_mac_capturer::InternalDecoderFactory>();
...
TEST(PeerConnectionFactoryTest, NativeToJavaPeerConnectionFactory) {
  ...
  rtc::scoped_refptr<webrtc_mac_capturer::PeerConnectionFactoryInterface> factory =
