...
using webrtc_mac_capturer::JavaParamRef;
using webrtc_mac_capturer::JavaRef;
using webrtc_mac_capturer::ScopedJavaLocalRef;
using webrtc_mac_capturer::LazyGetClass;
using webrtc_mac_capturer::MethodID;
