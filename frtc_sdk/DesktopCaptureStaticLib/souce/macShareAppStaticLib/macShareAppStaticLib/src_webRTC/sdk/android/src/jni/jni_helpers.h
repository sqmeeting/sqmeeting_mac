...
using ::webrtc_mac_capturer::JavaToStdMapStrings;
...
using webrtc_mac_capturer::AttachCurrentThreadIfNeeded;
using webrtc_mac_capturer::jni::InitGlobalJniVariables;
