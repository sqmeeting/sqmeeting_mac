...
public interface VideoDecoder {
   ...
   * a raw pointer of type webrtc_mac_capturer::VideoDecoder* (ownership is transferred to
   * the caller). The native library should then directly call the
   * webrtc_mac_capturer::VideoDecoder interface without going through JNI. All calls to
