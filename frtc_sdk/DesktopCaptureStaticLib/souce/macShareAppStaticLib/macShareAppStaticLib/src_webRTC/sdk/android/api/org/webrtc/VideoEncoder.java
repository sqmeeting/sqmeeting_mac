...
public interface VideoEncoder {
   ...
   * a raw pointer of type webrtc_mac_capturer::VideoEncoder* (ownership is transferred to
   * the caller). The native library should then directly call the
   * webrtc_mac_capturer::VideoEncoder interface without going through JNI. All calls to
