...
// Creates an instance of webrtc_mac_capturer::SdpVideoFormat from Java VideoCodecInfo.
SdpVideoFormat JavaToNativeVideoCodecInfo(JNIEnv* jni, jobject codec_info);

// Creates an instance of webrtc_mac_capturer::VideoDecoderFactory from Java
// VideoDecoderFactory.
std::unique_ptr<VideoDecoderFactory> JavaToNativeVideoDecoderFactory(
    JNIEnv* jni,
    jobject decoder_factory);

// Creates an instance of webrtc_mac_capturer::VideoEncoderFactory from Java
// VideoEncoderFactory.
