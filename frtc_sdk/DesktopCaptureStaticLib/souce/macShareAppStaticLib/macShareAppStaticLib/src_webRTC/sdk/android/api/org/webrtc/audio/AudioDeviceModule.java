...
/**
 * This interface is a thin wrapper on top of a native C++ webrtc_mac_capturer::AudioDeviceModule (ADM). The
...
public interface AudioDeviceModule {
  /**
   * Returns a C++ pointer to a webrtc_mac_capturer::AudioDeviceModule. Caller does _not_ take ownership and
