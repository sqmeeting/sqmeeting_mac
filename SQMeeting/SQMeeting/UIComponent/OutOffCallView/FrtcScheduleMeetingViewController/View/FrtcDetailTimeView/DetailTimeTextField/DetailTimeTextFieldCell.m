...
@implementation DetailTimeTextFieldCell
...
- (NSRect)adjustedFrameToVerticallyCenterText:(NSRect)frame {
    ...
    centeredRect = CGRectMake(0, 0, 26, 20);
    centeredRect = CGRectMake(0, 0, 26, 15);
    return centeredRect;
}
...
- (NSRect)drawingRectForBounds:(NSRect)rect{
    ...
    newRect = CGRectMake(0, 0, 24, 18);
    newRect = CGRectMake(0, 0, 24, 15);
    return newRect;
}
